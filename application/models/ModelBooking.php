...
class ModelBooking extends CI_Model
{
    ...
    public function simpanDetail($where = null)
    {
      ...
      _booking,temp.id_buku FROM booking, temp WHERE temp.id_user=booking.id_user
      AND b ooking.id_user='$where'";
      $this->db->query($sql);
    }
    ...
    public function createTemp()
    {
      ...
      tgl_booking DATET IME, email_user varchar(128), id_buku int)');
    }
